...
<div class="m-3">
	<a class="btn-outline-success" type="button"  href="/xuat-danh-sach-nhan-su-theo-chuc-vu">Quay Lại</a>
</div>
<div class="content-info-nhan-su">
	<div class="content-table">
		...
		<div class="table-btn">
			<a class="btn bg-btn"   href="/Xuat-bao-cao-thong-ke-danh-sach-nhan-su-chuc-vu/{{$ok}}" >Xuất Danh Sách</a>
		</div>
	</div>
