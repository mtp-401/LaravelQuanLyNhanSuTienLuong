...
if($noti == 'false'){
	@endphp
	<script type="text/javascript">
		swal("error!", "Đã xảy ra lỗi, Hãy thử lại!", "error");
	</script>
	@php 
}
@endphp 
<div class="content-info-nhan-su">
	<div class="content-table">
		<div class="table-name">
			<h3>Quản lý thông tin nhân sự</h3>
		</div>
		<div>
		...
		<tbody>
			...
			@foreach ($infoPersonnels as $item)
				...
				<tr class="AnHopDong{{$item->manv}} HienHopDong">
					<td colspan="8" style="wight=100%">
					<i>Danh sách hợp đồng</i>
						<table class="m-2 auto text-primary"  style="wight=100%">
